...
public class RegisterScane {
    public static void show(Stage stage) {
        ...
        // membuka jendela file, jika file dipilih maka akan diubah jadi image dan
        // ditampilkan
        ...
        submitButton.setOnAction(e -> {
            if (nickField.getText().isEmpty() || fullField.getText().isEmpty() || selectedImage[0] == null) {
                ...
                alert.setHeaderText(null);// menampilkan pesan error
                ...
                HomeScane.show(stage); // jika sudah lengkap akan pindah ke halaman utama
            }
        });
