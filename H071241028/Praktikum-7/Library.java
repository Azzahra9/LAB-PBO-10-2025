...
public class Library {
    ...
    // Mengakses objek LibraryLogger untuk mencatat atau melihat log aktivitas.
    public LibraryLogger getLogger() {
        return logger;
    }

    // Memberikan akses ke seluruh data anggota (Member) yang tersimpan dalam perpus
    public List<Member> getMembers() {
        return members;
    }

    //// Memberikan akses ke daftar semua item perpustakaan.
